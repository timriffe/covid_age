# -*- coding: utf-8 -*-
"""
Created on Sun Aug 22 13:38:43 2021
...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 15 13:53:58 2021
...
element = driver.find_element(By.ID, 'demo-export018')
driver.execute_script("arguments[0].click();", element)
time.sleep(5)


element = driver.find_element(By.ID, 'dwn-data-018')
driver.execute_script("arguments[0].click();", element)
time.sleep(5)

"""

element = driver.find_element_by_id('demo-export010')
driver.execute_script("arguments[0].click();", element)
time.sleep(5)


element = driver.find_element_by_id('dwn-data-010')
driver.execute_script("arguments[0].click();", element)
time.sleep(5)


element = driver.find_element_by_id('demo-export017')
driver.execute_script("arguments[0].click();", element)
time.sleep(5)


element = driver.find_element_by_id('dwn-data-017')
driver.execute_script("arguments[0].click();", element)
time.sleep(5)



element = driver.find_element_by_id('demo-export009')
driver.execute_script("arguments[0].click();", element)
time.sleep(5)


element = driver.find_element_by_id('dwn-data-009')
driver.execute_script("arguments[0].click();", element)
time.sleep(5)
