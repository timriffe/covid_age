...
driver.get("https://visual-data.dhsoha.state.or.us/t/OHA/views/OregonCOVID-19VaccinationTrends-SummaryTable/OregonCOVID-19VaccineProviderEnrollmentSummaryTable?:showAppBanner=false&:display_count=n&:showVizHome=n&:origin=viz_share_link&:isGuestRedirectFromVizportal=y&:embed=y")
...
download_button2 = driver.find_elements_by_xpath('//*[@class="fppw03o low-density"]')[2]
...
download_button4 = driver.find_elements_by_xpath('//*[@class="fdiufnn low-density"]')[0]
