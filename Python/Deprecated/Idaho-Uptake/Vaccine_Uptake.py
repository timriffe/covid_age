# -*- coding: utf-8 -*-
"""
Created on Mon Aug  9 15:42:47 2021
...
driver.get("https://public.tableau.com/views/COVID-19VaccineDataDashboard/VaccineUptakeIdahoIIS?%3Adisplay_static_image=y&%3AbootstrapWhenNotified=true&%3Aembed=true&%3Alanguage=en-GB&:embed=y&:showVizHome=n&:apiID=host0#navType=0&navSrc=Parse")
...
#download_button3 = driver.find_elements_by_xpath('//*[@class="thumbnail-wrapper_f1gupj42')[12]
download_button3=driver.find_elements_by_xpath('//span[@class="thumbnail-title_fmb090t"]')[3]
download_button3.click()
time.sleep(5)
...
#download_button3 = driver.find_elements_by_xpath('//*[@class="thumbnail-wrapper_f1gupj42')[12]
download_button3=driver.find_elements_by_xpath('//span[@class="thumbnail-title_fmb090t"]')[4]
download_button3.click()
time.sleep(5)
