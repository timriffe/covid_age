...
# NOTE
File storage for this database in the middle of shifting from github to OSF exclusively. The following code works, but it refers to earlier versions of files, rather than the most up to date versions. This code will be updated soon to show how to read directly from OSF to R.
