...
Let's walk through some commonly made plots of this kind of data. These are a pretty random selection. Different examples are found in the tabs. Code donations gladly accepted `r emo::ji("sunglasses")`
...
STMF <- 
  read_csv(unzip("STMFinput.zip", "DNKstmf.csv")) %>% 
  filter(Year == 2020) %>% 
  group_by(Week, Sex) %>% 
