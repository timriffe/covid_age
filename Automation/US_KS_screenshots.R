...
ks_cases_png  <- paste0("N:/COVerAGE-DB/Automation/Hydra/Data_sources/US_KS/US_KS_cases_",today(),".png")

ks_deaths_png  <- paste0("N:/COVerAGE-DB/Automation/Hydra/Data_sources/US_KS/US_KS_deaths_",today(),".png")
