...
cdc_archived <- data.table::fread(paste0(dir_n_source, "/Historical/", "United_States_COVID-19_Cases_and_Deaths_by_State_over_Time_-_ARCHIVED.csv"))

raw_data <- cdc_archived %>% 
  select(submission_date, conf_cases, conf_death)
