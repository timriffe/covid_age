...
## these data are updated monthly; in case we may shift to it completely instead of python. 



```{r}

cdc_monthly <- data.table::fread("https://data.cdc.gov/api/views/n8mc-b4w4/rows.csv?accessType=DOWNLOAD&bom=true&format=true&delimiter=%3B")
...
ctr_deaths <- "Romania/DEATHS-JUNE2022"
dir_n   <- "N:/COVerAGE-DB/Automation/Hydra/"
...
deaths_out <- bind_rows(deaths_new, epi_total)

## to continue when Larbi share the data 
