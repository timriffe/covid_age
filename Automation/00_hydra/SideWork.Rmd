...
Cases <- read_excel("N:/COVerAGE-DB/Automation/Hydra/Data_sources/Canada/WayBackMacineData-2021-2022.xlsx", 
                    sheet = "Cases") %>% 
...
Deaths <- read_excel("N:/COVerAGE-DB/Automation/Hydra/Data_sources/Canada/WayBackMacineData-2021-2022.xlsx", 
                     sheet = "Deaths") %>% 
  select(Date, Age, AgeInt, b, m, f, UNK) %>% 
  mutate(Age = as.character(Age),
         AgeInt = as.character(AgeInt),
