...
log_update(pp = ctr, N = nrow(new_data))

# now archive new data 

data_source_1 <- paste0(dir_n, "Data_sources/", ctr, "/vaccine1_age_",date_f, ".csv")
data_source_2 <- paste0(dir_n, "Data_sources/", ctr, "/vaccine1_sex_",date_f, ".csv")
data_source_3 <- paste0(dir_n, "Data_sources/", ctr, "/vaccine2_age_",date_f, ".csv")
data_source_4 <- paste0(dir_n, "Data_sources/", ctr, "/vaccine2_sex_",date_f, ".csv")

write_csv(age_vac1_in, data_source_1)
write_csv(sex_vac1_in, data_source_2)
write_csv(age_vac2_in, data_source_3)
write_csv(sex_vac2_in, data_source_4)


data_source <- c(data_source_1, data_source_2,data_source_3, data_source_4)
