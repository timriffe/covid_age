...
sched("USA_deaths_states", tm = "14:34",email = auto_update_email, wd = auto_update_wd)
sched("Sweden", tm = "16:01",email = auto_update_email, wd = auto_update_wd)
sched("Peru", tm = "14:40",email = auto_update_email, wd = auto_update_wd)
sched("Germany", tm = "14:50",email = auto_update_email, wd = auto_update_wd)
sched("US_Massachusetts", tm = "17:18",email = auto_update_email, wd = auto_update_wd)
sched("Colombia",  tm = "15:00",email = auto_update_email, wd = auto_update_wd)
sched("US_NYC", tm = "15:15",email = auto_update_email, wd = auto_update_wd)
sched("Austria", tm = "09:25",email = auto_update_email, wd = auto_update_wd)
# sched("ES_Basque_Country", tm = "11:00",email = auto_update_email, wd = auto_update_wd, sch = "WEEKLY")
sched("Philippines", tm = "15:20",email = auto_update_email, wd = auto_update_wd)
sched("Scotland", tm = "15:25",email = auto_update_email, wd = auto_update_wd)
sched("Norway", tm = "15:30",email = auto_update_email, wd = auto_update_wd)
sched("US_California", tm = "15:35",email = auto_update_email, wd = auto_update_wd)
sched("Afghanistan", tm = "15:40",email = auto_update_email, wd = auto_update_wd)
sched("ECDC", tm = "15:45",email = auto_update_email, wd = auto_update_wd, sch = "WEEKLY")
sched("Finland", tm = "15:50",email = auto_update_email, wd = auto_update_wd, sch = "WEEKLY")
sched("US_Wisconsin", tm = "16:02",email = auto_update_email, wd = auto_update_wd)
sched("Bulgaria", tm = "16:05",email = auto_update_email, wd = auto_update_wd)
sched("Denmark", tm = "16:10",email = auto_update_email, wd = auto_update_wd)
# sched("US_Iowa"•, tm = "09:40",email = auto_update_email, wd = auto_update_wd)
sched("Belgium", tm = "16:20",email = auto_update_email, wd = auto_update_wd)
sched("New_Zealand", "16:30",email = auto_update_email, wd = auto_update_wd)
sched("Mexico", "16:40",email = auto_update_email, wd = auto_update_wd)
sched("Thailand", "17:00",email = auto_update_email, wd = auto_update_wd)
