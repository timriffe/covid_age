...
sched("Norway", tm = "16:30",email = auto_update_email, wd = auto_update_wd)
sched("US_California", tm = "16:35",email = auto_update_email, wd = auto_update_wd)
...
sched("Bulgaria", tm = "23:05",email = auto_update_email, wd = auto_update_wd)
sched("Denmark", tm = "12:28",email = auto_update_email, wd = auto_update_wd)
...
sched("Chile_vacc", "01:03",email = auto_update_email, wd = auto_update_wd)
sched("Hungary", "00:49",email = auto_update_email, wd = auto_update_wd)
sched("Vietnam", "00:40",email = auto_update_email, wd = auto_update_wd)
sched("Italy", "07:00",email = auto_update_email, wd = auto_update_wd)
