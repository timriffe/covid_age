...
scripts <- c('Peru', 'PeruVaccine' , 
             ...
             'Denmark', 'Estonia', 'England', 'England_and_Wales',
             ...
             'IndiaVax', 'Italy', 'Ireland', 'Italy_reg', 
             'Island_of_Jersey', 'Israel',
             'Japan', 'LebanonVax',
             'Mexico', 'Maldives', 'Malaysia',
             'Nepal', 'Netherlands', 'New_Zealand',  
             'Norway_Vaccine', 'Philippines', 'Puerto_Rico', 
             'Spain', 'Spain_vaccine',
             'Scotland', 'Slovakia',  'Slovenia', 
             'SouthAfrica', 'SouthKorea', 'SriLankaPDFs',
             'SwedenEpi', 'SwedenVax', 
