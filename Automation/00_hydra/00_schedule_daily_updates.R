...
#################################################
sched("Slovenia", tm = "15:50",email = auto_update_email, wd = auto_update_wd)
sched("US_Virginia", tm = "15:55",email = auto_update_email, wd = auto_update_wd)
sched("USA_all_deaths", tm = "15:00",email = auto_update_email, wd = auto_update_wd)
sched("Netherlands", tm = "15:40",email = auto_update_email, wd = auto_update_wd)
sched("Estonia", tm = "15:45",email = auto_update_email, wd = auto_update_wd)
sched("Czechia", tm = "15:50",email = auto_update_email, wd = auto_update_wd)
sched("US_Michigan", tm = "15:40",email = auto_update_email, wd = auto_update_wd)
sched("Venezuela", tm = "15:31",email = auto_update_email, wd = auto_update_wd)
sched("US_Texas", tm = "15:32",email = auto_update_email, wd = auto_update_wd)
sched("USA_deaths_states", tm = "15:34",email = auto_update_email, wd = auto_update_wd)
sched("Sweden", tm = "15:00",email = auto_update_email, wd = auto_update_wd)
sched("Peru", tm = "16:40",email = auto_update_email, wd = auto_update_wd)
sched("Germany", tm = "16:35",email = auto_update_email, wd = auto_update_wd)
sched("US_Massachusetts", tm = "17:18",email = auto_update_email, wd = auto_update_wd)
sched("Colombia",  tm = "17:30",email = auto_update_email, wd = auto_update_wd)
...
sched("ECDC", tm = "16:57",email = auto_update_email, wd = auto_update_wd, sch = "WEEKLY")
...
sched("Belgium", tm = "13:30",email = auto_update_email, wd = auto_update_wd)
sched("New_Zealand", "15:03",email = auto_update_email, wd = auto_update_wd)
