...
#################################################
sched("Slovenia", tm = "11:03",email = auto_update_email, wd = auto_update_wd)
sched("US_Virginia", tm = "11:06",email = auto_update_email, wd = auto_update_wd)
sched("USA_all_deaths", tm = "11:10",email = auto_update_email, wd = auto_update_wd)
sched("Netherlands", tm = "10:14",email = auto_update_email, wd = auto_update_wd)
sched("Estonia", tm = "11:18",email = auto_update_email, wd = auto_update_wd)
sched("Czechia", tm = "11:22",email = auto_update_email, wd = auto_update_wd)
sched("US_Michigan", tm = "11:26",email = auto_update_email, wd = auto_update_wd)
sched("Venezuela", tm = "09:54",email = auto_update_email, wd = auto_update_wd)
sched("US_Texas", tm = "11:32",email = auto_update_email, wd = auto_update_wd)
...
sched("Peru", tm = "11:40",email = auto_update_email, wd = auto_update_wd)
sched("Germany", tm = "10:51",email = auto_update_email, wd = auto_update_wd)
...
sched("US_NYC", tm = "11:24",email = auto_update_email, wd = auto_update_wd)
sched("Austria", tm = "11:21",email = auto_update_email, wd = auto_update_wd)
# sched("ES_Basque_Country", tm = "11:00",email = auto_update_email, wd = auto_update_wd, sch = "WEEKLY")
sched("Philippines", tm = "12:14",email = auto_update_email, wd = auto_update_wd)
sched("Scotland", tm = "13:25",email = auto_update_email, wd = auto_update_wd)
sched("Norway", tm = "11:28",email = auto_update_email, wd = auto_update_wd)
sched("US_California", tm = "11:35",email = auto_update_email, wd = auto_update_wd)
sched("Afghanistan", tm = "13:40",email = auto_update_email, wd = auto_update_wd)
# sched("ECDC", tm = "13:45",email = auto_update_email, wd = auto_update_wd, sch = "WEEKLY")
sched("Finland", tm = "13:50",email = auto_update_email, wd = auto_update_wd, sch = "WEEKLY")
sched("US_Wisconsin", tm = "14:02",email = auto_update_email, wd = auto_update_wd)
sched("Bulgaria", tm = "14:46",email = auto_update_email, wd = auto_update_wd)
...
sched("Belgium", tm = "14:20",email = auto_update_email, wd = auto_update_wd)
sched("New_Zealand", "13:30",email = auto_update_email, wd = auto_update_wd)
sched("Mexico", "14:40",email = auto_update_email, wd = auto_update_wd)
sched("Thailand", "14:00",email = auto_update_email, wd = auto_update_wd)
sched("Spain", "12:01",email = auto_update_email, wd = auto_update_wd)
sched("US_Oregon", "14:18",email = auto_update_email, wd = auto_update_wd)
...
sched("Ukraine", "11:40",email = auto_update_email, wd = auto_update_wd)
sched("Spain_vaccine", "14:35",email = auto_update_email, wd = auto_update_wd)
