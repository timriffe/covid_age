...
out= rbind(DataArchive,case_sex_out, case_age_out, death_age_out, death_sex_out)%>%
  unique()
...
data_source2 <- paste0(dir_n, "Data_sources/", ctr, "/deaths_age_",today(), ".csv")
data_source3 <- paste0(dir_n, "Data_sources/", ctr, "/cases_sex_",today(), ".csv")
data_source4 <- paste0(dir_n, "Data_sources/", ctr, "/deaths_sex_",today(), ".csv")


write_csv(cases_age_in, data_source1)
write_csv(death_age_in, data_source2)
write_csv(cases_sex_in, data_source3)
write_csv(death_sex_in, data_source4)
