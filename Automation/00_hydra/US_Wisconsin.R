...
# spec(db)
db <- db0 %>% 
  select(RptDt, POS_CUM_CP, DTH_CUM_CP, TESTS_CUM, POS_FEM_CP, POS_MALE_CP, POS_0_9_CP, POS_10_19_CP, POS_20_29_CP, 
         POS_30_39_CP, POS_40_49_CP, POS_50_59_CP, POS_60_69_CP, POS_70_79_CP, 
         POS_80_89_CP, POS_90_CP, DTHS_FEM_CP, DTHS_MALE_CP, DTHS_0_9_CP,
         DTHS_10_19_CP, DTHS_20_29_CP, DTHS_30_39_CP, DTHS_40_49_CP, DTHS_50_59_CP, 
         DTHS_60_69_CP, DTHS_70_79_CP, DTHS_80_89_CP, DTHS_90_CP)
db <- melt(db, id = "RptDt")
db_out <- db %>% 
  mutate(Age = case_when(
    variable == "POS_CUM_CP" ~ "TOT",    
    variable == "DTH_CUM_CP" ~ "TOT",     
    ...
    variable == "DTHS_FEM_CP" ~ "TOT",  
    variable == "DTHS_MALE_CP" ~ "TOT",   
    variable == "DTHS_0_9_CP" ~ "0", 
    variable == "DTHS_10_19_CP" ~ "10", 
    variable == "DTHS_20_29_CP" ~ "20", 
    variable == "DTHS_30_39_CP" ~ "30", 
    variable == "DTHS_40_49_CP" ~ "40", 
    variable == "DTHS_50_59_CP" ~ "50", 
    variable == "DTHS_60_69_CP" ~ "60", 
    variable == "DTHS_70_79_CP" ~ "70", 
    variable == "DTHS_80_89_CP" ~ "80",    
    variable == "DTHS_90_CP" ~ "90"), 
    Measure = case_when(
      variable == "POS_CUM_CP" ~ "Cases",    
      variable == "DTH_CUM_CP" ~ "Deaths",     
      ...
      variable == "DTHS_FEM_CP" ~ "Deaths",  
      variable == "DTHS_MALE_CP" ~ "Deaths",   
      variable == "DTHS_0_9_CP" ~ "Deaths", 
      variable == "DTHS_10_19_CP" ~ "Deaths", 
      variable == "DTHS_20_29_CP" ~ "Deaths", 
      variable == "DTHS_30_39_CP" ~ "Deaths", 
      variable == "DTHS_40_49_CP" ~ "Deaths", 
      variable == "DTHS_50_59_CP" ~ "Deaths", 
      variable == "DTHS_60_69_CP" ~ "Deaths", 
      variable == "DTHS_70_79_CP" ~ "Deaths", 
      variable == "DTHS_80_89_CP" ~ "Deaths",    
      variable == "DTHS_90_CP" ~ "Deaths" 
    ),
    Sex = case_when(
      variable == "POS_CUM_CP" ~ "b",    
      variable == "DTH_CUM_CP" ~ "b",     
      ...
      variable == "DTHS_FEM_CP" ~ "f",  
      variable == "DTHS_MALE_CP" ~ "m",   
      variable == "DTHS_0_9_CP" ~ "b", 
      variable == "DTHS_10_19_CP" ~ "b", 
      variable == "DTHS_20_29_CP" ~ "b", 
      variable == "DTHS_30_39_CP" ~ "b", 
      variable == "DTHS_40_49_CP" ~ "b", 
      variable == "DTHS_50_59_CP" ~ "b", 
      variable == "DTHS_60_69_CP" ~ "b", 
      variable == "DTHS_70_79_CP" ~ "b", 
      variable == "DTHS_80_89_CP" ~ "b",    
      variable == "DTHS_90_CP" ~ "b" 
    ),
    AgeInt = case_when(
      Age == "0" ~ 10L,
      Age == "10" ~ 10L,
