...
py_file <- "C:/Users/riffe/Documents/covid_age/Automation/US_Missouri_screencaptures.py"
...
file.rename("N:/COVerAGE-DB/Automation/Hydra/Data_sources/Indonesia/US_MO_demo.png",
            file_out1)
file_out2 <- paste0("N:/COVerAGE-DB/Automation/Hydra/Data_sources/US_Missouri/US_MO_demo_",today(),".png")
file.rename("N:/COVerAGE-DB/Automation/Hydra/Data_sources/US_Missouri/US_MO_totals.png",
            file_out2)

files_out <- c(file_out1, file_out2)
drive_put(media = files_out,
...
if (schedule.this){
  ...
  taskscheduler_create(taskname = "COVerAGE-DB-US_MO_screencaptures", 
                       rscript = "C:/Users/riffe/Documents/covid_age/Automation/US_Missouri_screencaptures.R", 
                       schedule = "DAILY", 
