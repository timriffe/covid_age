...
#To create data
c <- c %>% separate(Fecha, c("Y","M", "D"), sep = "(-)")
...
unzip(temp, "DEFUNCIONES_FUENTE_DEIS_2016_2021_11032021.csv")
...
# To save a copy of raw data of confirmed cases from DEIS in COVerAGE metadata
#To save on COVerAGE-BD folder
dd7 <- 
  dd1 %>% 
  filter(CODIGO_GRUPO == "U071")
