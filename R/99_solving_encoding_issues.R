...
write_csv(out05_enc, "N:/COVerAGE-DB/website_data/web_out05.csv", 
          na = "")
write_csv(out10_enc, "N:/COVerAGE-DB/website_data/web_out10.csv", 
          na = "")
write_csv(input_enc, "N:/COVerAGE-DB/website_data/web_input.csv", 
          na = "")
